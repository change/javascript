...
export default function transformer(file, api, options) {
  ...
  if (found) {
    ...
    const variableDec = j.variableDeclaration("const", [j.variableDeclarator(j.identifier(identifier), j.callExpression(j.identifier("require"), [j.literal(packageName)]))]);
